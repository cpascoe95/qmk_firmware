 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl |   `  |  OS  | Alt  |Lower |    Space    |Raise | Left | Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 */
...
[_LOWER] = LAYOUT_planck_grid(
    RALT(KC_I), KC_EXLM, KC_AT,   KC_HASH,    KC_DLR,   KC_PERC, KC_CIRC, KC_AMPR,    KC_ASTR,  KC_LPRN, KC_RPRN, CUST_BSCP,
    KC_DEL,     KC_UNDS, KC_PLUS, KC_MINS,    KC_EQL,   _______, KC_BSPC, KC_ENT,     SEND_YES, KC_LCBR, KC_RCBR, KC_PIPE,
    _______,    _______, _______, UC(EMDASH), UC(GBP),  _______, _______, S(KC_NUHS), SEND_NO,  KC_LBRC, KC_RBRC, _______,
...
[_RAISE] = LAYOUT_planck_grid(
    KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    CUST_BSCP,
...
[_ADJUST] = LAYOUT_planck_grid(
    ...
    _______, AU_ON,   AU_OFF,  _______, VIM_CNF, _______, _______, _______, _______, _______, _______, _______,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
)
