...
[_LOWER] = LAYOUT_planck_grid(
    ...
    KC_CAPS, KC_UNDS, KC_PLUS, KC_MINS,    KC_EQL,   _______, KC_BSPC,    KC_ENT,  _______, KC_LCBR, KC_RCBR, KC_PIPE,
    _______, _______, _______, UC(EMDASH), UC(GBP),  _______, _______,    _______, _______, KC_LBRC, KC_RBRC, _______,
    _______, _______, _______, _______,    _______,  _______, RALT(KC_I), _______, _______, _______, _______, _______
),
